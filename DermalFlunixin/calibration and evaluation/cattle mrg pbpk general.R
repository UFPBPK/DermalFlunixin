...
//skin parameters based on Van der Merwe et al. 2006
  ...
  area             :1200     :  skin surface area (mm**2)
  ...
  QCC        : 5.97     :                       Cardiac output (L/h/kg), Li et al. 2019
  QLCa       : 0.405     :                       Fraction of flow to the liver, Li et al. 2019
  QKCa       : 0.09 	   :                       Fraction of flow to the kidneys, Li et al. 2019
  QFCa       : 0.08      :                       Fraction of flow to the fat, Li et al. 2019
  QMCa       : 0.18      :                       Fraction of flow to the muscle, Li et al. 2019
  ...
  VbloodCa   : 0.04      :                       Unitless, Fraction vol. of blood; Li et al. 2019               
  VLCa       : 0.014    :                       Unitless, Fraction vol. of liver; Li et al. 2019
  VKCa       : 0.0025    :                       Unitless, Fraction vol. of kidney; Li et al. 2019
  VFCa       : 0.150    :                       Unitless, Fractional fat tissue, Li et al. 2019
  VMCa       : 0.270     :                       Unitless, Fractional muscle tissue, Li et al. 2019
  VartCa     : 0.010     :                       Unitless, Fractional arterial blood, Li et al. 2019
  VvenCa     : 0.030     :                       Unitless, Fractional venous blood, Li et al. 2019
  ...
  PK        : 4         :                     Kidney plasma PC Li et al. 2019
  PM        : 0.5       :                     Muscle plasma PC Li et al. 2019
  PF        : 0.6       :                     Fatp plasma PC Li et al. 2019
  ...
  BW        : 60.2     : kg, Bodyweight of swine, 
...
double CLppm = CL*MW; //()
dxdt_AUCCL = CL*MW; // AUCCL area under the curve of drug concentration in liver (mg*h/L)
...
double CL1ppm = CL1*MW1; // //(ng/mL)
dxdt_AUCCL1 = CL1*MW; // AUCCL1 area under the curve of drug concentration in liver (mg*h/L)
...
dxdt_AUCCK = CK*MW; // AUCCK AUC of drug concentration in kidney (mg*h/L)
double CKppm = CK*MW; //
...
dxdt_AUCCK1 = CK1*MW1; // AUCCK AUC of drug concentration in kidney (mg*h/L)
...
dxdt_AUCCF = CF*MW; // AUCCF AUC of drug concentration in fat (mg*h/L)
double CFppm = CF*MW;//
...
dxdt_AUCCR = CR*MW; // AUCCrest AUC of drug concentration in the rest of the body (mg*h/L)
double CRppm = CR*MW;//
...
dxdt_AUCCR1 = CR1*MW1; // AUCCrest AUC of drug concentration in the rest of the body (mg*h/L)
